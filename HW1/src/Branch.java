...
public class Branch{
    ...
    private final MyContainer<Product> products;
    private final MyContainer<Employee> employees;
    ...
    public Branch(String name,int id, Company company){
        ...
        products = new MyContainer<>();
        employees = new MyContainer<>();
    }
     ...
     */
    public MyContainer<Employee> getEmployees(){return employees;}

    /**
     * Return Products of Branch
     * @return Products of Branch
     */
    public MyContainer<Product> getProducts(){return products;}
