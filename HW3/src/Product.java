...
public class Product {
    ...
    public String toString(){
        return String.format("Product Name : %s\tModel : %s\t Color : %s\t Stock No : %d\tProduct ID : %d\n", getName(),getModel(),getColor(),getNumber(),getProductID());
    }
    ...
    public boolean equals(Object o) {
        ...
        return productID == product.productID && numberOfProduct == product.numberOfProduct && Objects.equals(name, product.name) && Objects.equals(model, product.model) && Objects.equals(color, product.color);
    }

    @Override
    public int hashCode() {
        return Objects.hash(productID, name, model, color, numberOfProduct);
    }
}
